...
<div class="container-fluid">
	...
	<div>
		<h2 class="text3">문의게시판</h2>
		<br>
		<p><span style="color : gray;">Home > 커뮤니티</span> > <b>문의게시판</b></p>
	</div>

	<div>
		<hr>
		<h6>Harang에 대한 궁금사항, 불편내용, 신고, 제안, 건의 등은 통합하여 운영됩니다.</h6>
		<h6>답변을 받으시려면 답변게시글에 글을 작성 해주세요.</h6>
		<h6>상업성광고, 저속한표현, 특정인에 대한 비방, 정치적목적이나 성향, 반복적 게시물 등은 관리자에 의해 통보없이 삭제될수 있습니다.</h6>
		<h6>또한, 홈페이지를 통하여 불법유해 정보를 게시하거나 배포하면 정보통신망 이용촉진 및 정보보호 등에 관한 법률 제74조에 의거</h6>
		<h6>1년이하의 징역 또는 1천만원 이하의 벌금에 처해질수 있습니다.</h6>
		<hr>
	</div>
	<div class="row">
		<div class="col-lg-8">
...
<!-- 		<button type="button" class="btn btn-primary btn-md reportBtn">신고</button> -->
	</div>
	<div>
